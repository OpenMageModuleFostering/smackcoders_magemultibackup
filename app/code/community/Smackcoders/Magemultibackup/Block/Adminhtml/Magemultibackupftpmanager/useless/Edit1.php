...
class Smackcoders_Magemultibackup_Block_Adminhtml_Magemultibackup_Edit1 extends Mage_Adminhtml_Block_Widget_Form_Container
{
...
return Mage::helper('magemultibackup')->__('Delete Backups');
    }
}
