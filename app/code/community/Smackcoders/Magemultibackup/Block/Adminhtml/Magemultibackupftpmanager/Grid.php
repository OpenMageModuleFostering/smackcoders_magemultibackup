...
class Smackcoders_Magemultibackup_Block_Adminhtml_Magemultibackupftpmanager_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('magemultibackupmanagerGrid');
    ...
    {
        $collection = Mage::getModel('magemultibackup/magemultibackup')->getCollection()->addFieldToFilter('ftpied', array('eq' => 1))->addFieldToFilter('ftpfiledeleted', array('eq' => 0));
        ...
        $this->addColumn('createdat', array(
            ...
            $this->addColumn('rollback', array(
                    ...
                    'actions'  => array(array(
                        ...
                        'onclick' => 'return backup.rollback(\'ftp\', \'$filename\');'
                    )),
                    'index'    => 'type',
                    'sortable' => false
            ));
